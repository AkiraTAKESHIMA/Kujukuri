...
real(8) function north_of_y(y) result(res)
  ...
  res = north - cellsize_lat * (y-1)
end function north_of_y
!===============================================================
!
!===============================================================
real(8) function lon_center_of_x(x) result(res)
  implicit none
  integer, intent(in) :: x

  res = west + cellsize_lon * (x-0.5d0)
end function lon_center_of_x
!===============================================================
!
!===============================================================
real(8) function lat_center_of_y(y) result(res)
  implicit none
  integer, intent(in) :: y

  res = north - cellsize_lat * (y-0.5d0)
...
integer function xs_of_lon(lon) result(res)
  ...
  res = floor((lon - west) / cellsize_lon) + 1
...
integer function xe_of_lon(lon) result(res)
  ...
  res = ceiling((lon - west) / cellsize_lon)
...
integer function ys_of_lat(lat) result(res)
  ...
  res = floor((north - lat) / cellsize_lat) + 1
...
integer function ye_of_lat(lat) result(res)
  ...
  res = ceiling((north - lat) / cellsize_lat)
