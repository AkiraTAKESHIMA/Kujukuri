...
module mod_sub
  ...
  ! Public procedures
  !-------------------------------------------------------------
  public :: riv_idx_setting
  public :: sub_riv_ij2idx
  public :: sub_riv_idx2ij
  public :: slo_idx_setting
