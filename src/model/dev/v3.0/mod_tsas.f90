...
!===============================================================
subroutine RRI_TSAS(&
  tt, hs_idx, hr_idx, hg_idx, gampt_f, &
  qs_ave_idx, qr_ave_idx, qg_ave_idx, qp_t_idx, qrs, &
  aevp_tsas, exfilt_hs_tsas, rech_hs_tsas &
)
  use mod_globals
  use mod_dam
  use mod_sub, only: &
  ...
  real(8), intent(in) :: hs_idx(slo_count)
  real(8), intent(in) :: hr_idx(slo_count)
  real(8), intent(in) :: hg_idx(slo_count)
  real(8), intent(in) :: gampt_f(ny, nx)
  real(8), intent(in) :: qs_ave_idx(i4, slo_count)
  real(8), intent(in) :: qr_ave_idx(riv_count)
  real(8), intent(in) :: qg_ave_idx(i4, slo_count)
  real(8), intent(in) :: qp_t_idx(slo_count)
  real(8), intent(in) :: qrs(ny, nx)
  real(8), intent(in) :: aevp_tsas(slo_count)
  real(8), intent(in) :: exfilt_hs_tsas(slo_count)
  real(8), intent(in) :: rech_hs_tsas(slo_count)
