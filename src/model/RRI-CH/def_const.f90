module def_const
  ...
  integer(4), parameter :: FDR_NORTH     = 1
  integer(4), parameter :: FDR_NORTHEAST = 2
  integer(4), parameter :: FDR_EAST      = 3
  integer(4), parameter :: FDR_SOUTHEAST = 4
  integer(4), parameter :: FDR_SOUTH     = 5
  integer(4), parameter :: FDR_SOUTHWEST = 6
  integer(4), parameter :: FDR_WEST      = 7
  integer(4), parameter :: FDR_NORTHWEST = 8
  integer(4), parameter :: FDR_OUTLET    = 0
  integer(4), parameter :: FDR_MISS      = -9

  integer(4), parameter :: DOMAIN_OUTSIDE = 0
  integer(4), parameter :: DOMAIN_INSIDE  = 1
  integer(4), parameter :: DOMAIN_OUTLET  = 2

  integer, parameter :: WIDTH_MODE__UPA  = 0
  integer, parameter :: WIDTH_MODE__FILE = 1
  integer, parameter :: DEPTH_MODE__UPA  = 0
  integer, parameter :: DEPTH_MODE__FILE = 1
  integer, parameter :: LEVEE_MODE__UPA  = 0
  integer, parameter :: LEVEE_MODE__FILE = 1
...
!  real(8), allocatable, save :: vr_temp(:), vr_err(:), hr_err(:)
