module def_const
  ...
  integer, parameter :: RIVER_SECTION_METHOD__AREA_ESTIMATION = 1
  integer, parameter :: RIVER_SECTION_METHOD__RECTANGULAR     = 2
  integer, parameter :: RIVER_SECTION_METHOD__EXPLICIT        = 3
